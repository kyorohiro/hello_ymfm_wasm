...
test('npm tarball installs offline, runs via npx, and exports the library',async()=>{
  ...
  try {
    ...
    for(const name of ['huc6280-tone','nes-tone','ym2610-mix','ym2610b-mix','okim6258-tone','opm-oki-mix','y8950-psg','ymf278b-psg','segapcm-bank1','segapcm-opm-psg','msx-scc','msx-ay-opll','msx-ay-opll-audio-scc','pwm-stream','pwm-all']) {
