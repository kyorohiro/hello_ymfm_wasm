...
em++ -std=c++14 -O2 \
  ...
  -sEXPORT_ALL=1 \
  -sEXPORTED_FUNCTIONS='["_ymf262_create","_ymf262_destroy","_ymf262_reset","_ymf262_write","_ymf262_read","_ymf262_read_status","_ymf262_get_irq","_ymf262_sample_rate","_ymf262_generate","_malloc","_free"]' \
