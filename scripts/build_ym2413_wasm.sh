...
em++ -std=c++14 \
  ...
  -sEXPORT_ALL=1 \
  -sEXPORTED_FUNCTIONS='["_ym2413_create","_ym2413_destroy","_ym2413_reset","_ym2413_write","_ym2413_read","_ym2413_read_status","_ym2413_get_irq","_ym2413_sample_rate","_ym2413_generate","_malloc","_free"]' \
