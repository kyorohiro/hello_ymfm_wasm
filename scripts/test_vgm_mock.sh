...
node --test web/vgm-parser-mock.test.mjs web/vgm-player-mock.test.mjs \
  web/segapcm-skip.test.mjs web/psg-stream.test.mjs web/vgm-compression.test.mjs web/vgm-delivery.test.mjs web/dac-stream.test.mjs web/dac-warning.test.mjs \
