import {installMidiImport} from './playground_midi_import.js?v=midi-channels-0';
import {
  FM_PRESET_ORDER,
  FM_PRESETS,
...
import { EXAMPLES } from "./playground_examples.js?v=midi-channels-0";
...
} from "../js/playground_runtime.js?v=midi-channels-0";
