import {installMidiImport} from './playground_midi_import.js?v=midi-events-output-2';
import {
  FM_PRESET_ORDER,
  FM_PRESETS,
...
import { EXAMPLES } from "./playground_examples.js?v=midi-events-output-2";
...
} from "../js/playground_runtime.js?v=midi-events-output-2";
