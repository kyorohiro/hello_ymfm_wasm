import {installMidiImport} from './playground_midi_import.js?v=midi-modes-1';
import {
  FM_PRESET_ORDER,
  FM_PRESETS,
...
import { EXAMPLES } from "./playground_examples.js?v=midi-modes-1";
...
} from "../js/playground_runtime.js?v=midi-modes-1";
