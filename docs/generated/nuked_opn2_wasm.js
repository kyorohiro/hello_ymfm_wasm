...
function findWasmBinary() {
  ...
  if (ENVIRONMENT_IS_SHELL) {
    return 'nuked_opn2_wasm.wasm';
  }

  if (Module['locateFile']) {
    return locateFile('nuked_opn2_wasm.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('nuked_opn2_wasm.wasm', import.meta.url).href;
...
var _ym2612_create = Module['_ym2612_create'] = makeInvalidEarlyAccess('_ym2612_create');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['ym2612_create'] != 'undefined', 'missing Wasm export: ym2612_create');
  ...
  _ym2612_create = Module['_ym2612_create'] = createExportWrapper('ym2612_create', wasmExports['ym2612_create'], 0);
