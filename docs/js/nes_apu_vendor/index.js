// JSNES (Apache-2.0). Tetorica adaptation: local import paths and output mute mask.
// See third_party/jsnes/README.md for source revision and attribution.
...
class PAPU {
  ...
  sample() {
    ...
    // Tetorica: output-only mute; keep timers, envelopes and DMC memory reads running.
    if (this.muteMask & 1) this.smpSquare1 = 0;
    if (this.muteMask & 2) this.smpSquare2 = 0;
    if (this.muteMask & 4) this.smpTriangle = 0;
    if (this.muteMask & 8) smpNoise = 0;
    if (this.muteMask & 16) this.smpDmc = 0;
    // Stereo sound.
