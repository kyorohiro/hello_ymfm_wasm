 ...
 */
class TetoricaStereoWidthProcessor extends AudioWorkletProcessor {
  ...
  process(inputs, outputs, parameters) {
    ...
    const leftIn =
      input[0] ??
      input[1] ??
      new Float32Array(output[0].length);
    const rightIn =
      input[1] ??
      input[0] ??
      leftIn;
