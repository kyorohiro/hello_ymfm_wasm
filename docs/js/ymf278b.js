...
export class Ymf278b {
  ...
  static async create(options = {}) {
    ...
    const api = {
      loadMemory: module.cwrap("ymf278b_load_memory", "number", ["number", "number", "number", "number", "number"]),
      clearMemory: module.cwrap("ymf278b_clear_memory", null, ["number"]),
      create: module.cwrap("ymf278b_create", "number", []),
      destroy: module.cwrap("ymf278b_destroy", null, ["number"]),
      reset: module.cwrap("ymf278b_reset", null, ["number"]),
      write: module.cwrap("ymf278b_write", null, ["number", "number", "number"]),
      read: optionalCwrap(module, "ymf278b_read", "number", ["number", "number"]),
